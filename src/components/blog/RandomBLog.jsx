...
const RandomBLog = () => {
    ...
    return (
        <>
            <h1 className='text-center text-3xl font-bold p-2 text-slate-900 '>İlgini Çekebilirler</h1>
            <div style={{
            ...
            <div className="flex flex-row justify-center flex-wrap items-center gap-6 gap-x-12 p-8 bg-white my-2">
