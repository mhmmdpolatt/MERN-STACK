...
import { useComplaintForCommentMutation, useComplaintForUserMutation } from '../../store/apis/userApi';

function ComplaintFormUser({ setSikayetForm,sikayetForm,userID }) {
    const [description, setDescription] = useState('');
    const [selectedType, setSelectedType] = useState('');
    const [error, setError] = useState('');
    const [complaintForUser] = useComplaintForUserMutation();
    ...
    return (
        <div className="w-[380px] mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <h4 className="text-sm font-semibold text-gray-800 mb-4 text-center">Kullanıcıyı Şikayet Ediyorsunuz</h4>
...
export default ComplaintFormUser;
